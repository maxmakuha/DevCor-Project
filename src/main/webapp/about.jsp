...
<br>The system shall allow user to interact with it using one of the following roles: </p>
<ul><li>Administrator</li><li>Technician</li><li>User</li></ul>
<p class="lead">
...
</p><img src="img/2.PNG" class="img-rounded">
